      ...
      <div className="container mx-auto">
        <div className="text-center mb-16 animate-fade-in">
          <h2 className="text-4xl font-bold mb-4">
            <span className="text-gradient">Hubungi</span> Saya
          </h2>
          ...
          <div className="space-y-8 animate-fade-in-left">
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed mb-8">
                Saya selalu antusias untuk mendengar tentang project baru, peluang kolaborasi, 
                atau sekadar ngobrol tentang teknologi. Jangan ragu untuk menghubungi saya!
              </p>
            </div>
            ...
            <div className="space-y-6">
              {contactInfo.map((info, index) => (
                <a
                  key={index}
                  href={info.href}
                  className="flex items-center space-x-4 p-4 rounded-lg border border-border/50 hover:border-primary/50 transition-colors group"
                >
